...
module.exports = createServer(async (req, res) => {
  ...
  .on('listening', () => {
    if (process.env.NODE_ENV !== 'test') {
      console.log(`Server CRM is launched. You can use it by click on the following link http://localhost:${PORT}`);
      console.log('Press CTRL+C, to stop the server');
      console.log('Available methods:');
      console.log(`GET ${URI_PREFIX} - get client's list, also you can use 'search' as query paramether`);
      console.log(`POST ${URI_PREFIX} - to create a Client, you need to send with request body an object, which has the following structure: { name: string, surname: string, lastName?: string, contacts?: object[] }`);
      console.log(`\tcontacts - massive with objects, that includes contacts of the following structure { type: string, value: string }`);
      console.log(`GET ${URI_PREFIX}/{id} - get Client by ID`);
      console.log(`PATCH ${URI_PREFIX}/{id} - to change Client by ID, you need to send with request body an object, which has the following structure: { name?: string, surname?: string, lastName?: string, contacts?: object[] }`);
      console.log(`\tcontacts -  massive with objects, that includes contacts of the following structure { type: string, value: string }`);
